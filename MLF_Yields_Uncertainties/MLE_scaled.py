### Filter definitions ###
print 'Hello World'
muo_ifile = ['mu_theta_narrow_rebinned.root']
ele_ifile = ['']
lep_ifile = ['']
...
def build_boosted_semileptonic_model(files, filter, signal, eflag=False):
    ...
    for p in model.processes:
        ...
        #you can scale your backgrounds to help theta converge, but you need a good guess of the prior
        #for obs in ['mu_0top_mttbar','mu_1top_mttbar']:
            #if 'ttbar' in p and '1top' in obs:
               # models.scale_predictions(0.72,obs)
        #if eflag:
    ...
    model.add_lognormal_uncertainty('st_rate',      math.log(1.15), 'singletop')
    model.add_lognormal_uncertainty('zj_rate',      math.log(1.15), 'zjets')
...
factors =print_obsproc_factors_shapes(model)
