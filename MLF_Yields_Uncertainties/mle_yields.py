...
#    model.add_lognormal_uncertainty('toptag',      math.log(1.5), 'ttbar')
 #   model.add_lognormal_uncertainty('toptag',      math.log(1.5), 'ttbar')
 #     for obs in ['el_1top_mttbar','el_1top_mttbar_highChi2']:
 #     for obs in ['el_1top_mttbar','el_1top_mttbar_highChi2']:
       
# model.add_lognormal_uncertainty('toptag', math.log(1.5), p, obs)
