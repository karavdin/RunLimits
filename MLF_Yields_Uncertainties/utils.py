...
def generate_yield_table_AN(rate_table,prefix,channel):
 ...
 #               'mu_0top_antiWJetsMVA2_chi2_mttbar': 'CR1',
                ...
                'mu_0top_antiWJetsMVA2_chi2_mttbar': 'CR3',
                'mu_0top_antiWJetsMVA3_chi2_mttbar': 'CR4',
#                'mu_0top_antiWJetsMVA3_chi2_mttbar': 'CR2',
        ...
        if channel=='elec':
            latex_colname = {'el_1top_mttbar': ' $N_{\\text{top-tag}}=1$, $\chi^{2}$<30',
                ...
                'ele_0top_antiWJetsMVA2_chi2_mttbar': 'CR3',
                'ele_0top_antiWJetsMVA3_chi2_mttbar': 'CR4',
...
#                 'ele_0top_WJetsMVA_step5_chi2_mttbar': 't0, bdt st5, $\chi^{2}$',
        ...
        if channel=='lep':
            latex_colname = {'mu_1top_mttbar': ' 1-t',
                ...
                'mu_0top_antiWJetsMVA2_chi2_mttbar': '$\mu$, CR3',
                'mu_0top_antiWJetsMVA3_antichi2_mttbar': '$\mu$, CR2',
                'mu_0top_antiWJetsMVA3_chi2_mttbar': '$\mu$, CR4',
                ...
                'ele_0top_antiWJetsMVA3_chi2_mttbar': '$e$, CR4',
                'ele_0top_antiWJetsMVA2_chi2_mttbar': '$e$, CR3',
