...
fout = TFile('mu_theta_wFlatShapeSyst_allSyst_wTopPtrewSymSyst_LIMITS_highMasses.root', 'recreate')
...
#                elif 'Zprime' or 'RSgluon' in key_sample:
                ...
                #if 'wjets_b' or 'wjets_c' or 'ST' or 'DY' or 'VV' in key_sample:
                elif key_sample=='wjets_b' or key_sample=='wjets_c' or key_sample=='ST' or key_sample=='DY' or key_sample=='VV' or key_sample=='qcd_mu':
                    for syst in systematic_direction_otherbkgs:
                        cut = str(cut_string+' & ttagN==1 &  btagN>=0)*(wgtMC__GEN)*'+systematic_direction_otherbkgs[syst])
                        ...
                        if syst == 'nominal':
                            ...
                            fout.WriteObject(tempsys,h_string+key_sample+"__"+syst)
                            del tempsys
                elif key_sample=='qcd_mu':
                    for syst in systematic_direction_otherbkgs:
                        cut = str(cut_string+' & ttagN==1 &  btagN>=0)*(wgtMC__GEN)*0*'+systematic_direction_otherbkgs[syst])
                        print "Processing small bkg: ",key_sample
                        print "Applying cut:",cut
                        print "For syst: ",syst
                        if syst == 'nominal':
        ...
        for subcat in subcategoriesT0:
            ...
            for key_sample in samplelist:
                    ...
                    if subcat == 'WJetsMVA_chi2':
                        ...
                        for syst in systematic_direction_wjets:
                            ...
                            if syst == 'nominal':
                                ...
                                fout.WriteObject(temp2sys,h_string+key_sample+"__"+syst)
                                del temp2sys
                elif key_sample=='wjets_b' or key_sample=='wjets_c' or key_sample=='ST' or key_sample=='DY' or key_sample=='VV':
                    for syst in systematic_direction_otherbkgs:
                        cut = str(cut_string+' & ttagN==0 & btagN>=0)*(wgtMC__GEN)*'+systematic_direction_otherbkgs[syst])
                        print "Processing small bkg: ",key_sample
                        print "Applying cut:",cut
                ...
                elif key_sample=='qcd_mu' and (subcat == 'antiWJetsMVA3_chi2' or subcat == 'WJetsMVA_chi2'):
                    for syst in systematic_direction_otherbkgs:
                        cut = str(cut_string+' & ttagN==0 & btagN>=0)*(wgtMC__GEN)*'+systematic_direction_otherbkgs[syst])
                        print "Processing small bkg: ",key_sample
                        print "Applying cut:",cut
                        ...
                        if syst == 'nominal':
                            ...
                            temp2sys.Print()
                            fout.WriteObject(temp2sys,h_string+key_sample+"__"+syst)
                elif key_sample=='qcd_mu' and (subcat == 'antiWJetsMVA2_chi2'):
                    for syst in systematic_direction_otherbkgs:
                        cut = str(cut_string+' & ttagN==0 & btagN>=0)*(wgtMC__GEN)*0*'+systematic_direction_otherbkgs[syst])
                        print "Processing small bkg: ",key_sample
                        print "Applying cut:",cut
                        print "For syst: ",syst
                        if syst == 'nominal':
