...
#muHLT_sys_cut=' & 0.96<weight_sfmu_HLT_up & weight_sfmu_HLT_up<1.1 & 0.8<weight_sfmu_HLT_down & weight_sfmu_HLT_down<1.0 '
muHLT_sys_cut=''
#q2_sys_cut=' & 0.0<wgtMC__muR_up__muF_up & wgtMC__muR_up__muF_up<2.0 & 0.0<wgtMC__muR_dn__muF_dn & wgtMC__muR_dn__muF_dn<2.0 '
q2_sys_cut=''
...
#                        cut = str(cut_string+' & ttagN>=0 &  btagN>=0)*(wgtMC__GEN)*'+systematic_direction_signal[syst])
                        cut = str(cut_string+muHLT_sys_cut+' & ttagN<1 &  btagN>=0)*(wgtMC__GEN)*'+systematic_direction_signal[syst])
                        print "Processing: ",key_sample
                        print "Applying cut:",cut
                        if syst == 'nominal':
...
#                        cut = str(cut_string+' & ttagN==1 & btagN>=0)*0.75*(wgtMC__GEN)*'+systematic_direction_ttbar[syst])
                        ...
                        cut = str(cut_string+muHLT_sys_cut+q2_sys_cut+' & ttagN<1 & btagN>=0)*1.00*(wgtMC__GEN)*'+systematic_direction_ttbar[syst])
                        print "Processing: ",key_sample
                        print "Applying cut:",cut
                        if syst == 'nominal':
                            temp = TH1F("temp","temp",30,100,2000)
...
#                        cut = str(cut_string+' &  ttagN>=0 &  btagN>=0)*(wgtMC__GEN)*'+systematic_direction_wjets[syst])
                        cut = str(cut_string+muHLT_sys_cut+q2_sys_cut+' &  ttagN<1 &  btagN>=0)*(wgtMC__GEN)*'+systematic_direction_wjets[syst])
                        print "Processing: ",key_sample
                        print "Applying cut:",cut
                        if syst == 'nominal':
                            temp = TH1F("temp","temp",30,100,2000)
                            ...
                            fout.WriteObject(tempsys,h_string+key_sample+"__"+syst)
                            del tempsys
                elif 'zjets' or 'diboson' or 'others' or 'wjets_b' or 'wjets_c' or 'DY' or 'ST' in key_sample:
                    for syst in systematic_direction_otherbkgs:
#                        cut = str(cut_string+' & ttagN>=0 &  btagN>=0)*(wgtMC__GEN)*'+systematic_direction_otherbkgs[syst])
                        cut = str(cut_string+muHLT_sys_cut+' & ttagN<1 &  btagN>=0)*(wgtMC__GEN)*'+systematic_direction_otherbkgs[syst])
                        print "Processing: ",key_sample
                        print "Applying cut:",cut
                        if syst == 'nominal':
                            temp = TH1F("temp","temp",30,100,2000)
...
#                mytree.SetAlias("invmass","sqrt(pow(rec_tlep.Energy()+rec_thad.Energy(),2)-(pow(rec_thad.Px(),2)+pow(rec_thad.Py(),2)+pow(rec_thad.Pz(),2)+pow(rec_tlep.Px(),2)+pow(rec_tlep.Py(),2)+pow(rec_tlep.Pz(),2)+2*(rec_thad.Px()*rec_tlep.Px()+rec_thad.Py()*rec_tlep.Py()+rec_thad.Pz()*rec_tlep.Pz())))")
                if key_sample == 'DATA':
                    ...
                    for syst in systematic_direction_signal:
                        cut = str(cut_string+muHLT_sys_cut+' & ttagN==0 & btagN>=0)*(wgtMC__GEN)*'+systematic_direction_signal[syst])
                        print "Processing: ",key_sample
                        print "Applying cut:",cut
                        if syst == 'nominal':
...
#                        cut = str(cut_string+' & ttagN==0 & btagN>=0)*0.75*(wgtMC__GEN)*'+systematic_direction_ttbar[syst])
                        cut = str(cut_string+muHLT_sys_cut+q2_sys_cut+' & ttagN==0 & btagN>=0)*1.00*(wgtMC__GEN)*'+systematic_direction_ttbar[syst])
                        print "Processing: ",key_sample
                        print "Applying cut:",cut
                        if syst == 'nominal':
                            temp2 = TH1F("temp2","temp2",30,100,2000)
...
#                elif 'wjets_l' or 'ST' in key_sample:
                    for syst in systematic_direction_wjets:
#                    for syst in systematic_direction_otherbkgs:
                        cut = str(cut_string+muHLT_sys_cut+q2_sys_cut+' & ttagN==0 & btagN>=0)*(wgtMC__GEN)*'+systematic_direction_wjets[syst])
                        print "Processing: ",key_sample
                        print "Applying cut:",cut
                        if syst == 'nominal':
                            temp2 = TH1F("temp2","temp2",30,100,2000)
...
#                elif 'zjets' or 'diboson' or 'others' or 'wjets_b' or 'wjets_c' or 'ST' or 'qcd' in key_sample:
                    ...
                    for syst in systematic_direction_otherbkgs:
                        cut = str(cut_string+muHLT_sys_cut+' & ttagN==0 & btagN>=0)*(wgtMC__GEN)*'+systematic_direction_otherbkgs[syst])
                        print "Processing: ",key_sample
                        print "Applying cut:",cut
                        if syst == 'nominal':
                            temp2 = TH1F("temp2","temp2",30,100,2000)
