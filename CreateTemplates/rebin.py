...
binFile(0.30,  'ele_theta_bdt0p5_chi30.root','M_{t#bar{t}} [GeV/c^{2}]', ['ttbar','wjets_l','wjets_c','wjets_b','qcd','diboson'])
binFile(0.30,  'mu_theta_bdt0p5_chi30.root','M_{t#bar{t}} [GeV/c^{2}]', ['ttbar','wjets_l','wjets_c','wjets_b','qcd','diboson'])
binFile(0.30,  'mu_theta_bdt0p5_chi30_limits.root','M_{t#bar{t}} [GeV/c^{2}]', ['ttbar','wjets_l','wjets_c','wjets_b','qcd','diboson'])
binFile(0.30,  'ele_theta_bdt0p5_chi30_limits.root','M_{t#bar{t}} [GeV/c^{2}]', ['ttbar','wjets_l','wjets_c','wjets_b','qcd','diboson'])
