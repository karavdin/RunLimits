...
fout = TFile('mu_theta_wFlatShapeSyst_narrowBins_min300.root', 'recreate')
...
#    cut_string_GL='(muoN==1 & Mttbar<2000. & rec_chi2<1000 & '
    cut_string_GL='(muoN==1 & Mttbar<2000. & Mttbar>300. & '
    if cat == 'T1':
        ...
        for subcat in subcategoriesT1:
            ...
            for key_sample in samplelist:
                ...
                if key_sample == 'DATA':
                    ...
                    tempdata = TH1F("tempdata","tempdata",100,100,2000)
                    ...
                    for syst in systematic_direction_signal:
                        ...
                        print "Applying cut:",cut
                        if syst == 'nominal':
                            temp = TH1F("temp","temp",100,100,2000)
                            ...
                            tempsys = TH1F("tempsys","tempsys",100,100,2000)
        ...
        for subcat in subcategoriesT0:
            ...
            for key_sample in samplelist:
                ...
                if key_sample == 'DATA':
                    ...
                    print "Processing: ",key_sample
                    print "Applying cut:",cut
                    temp2data = TH1F("temp2data","temp2data",100,100,2000)
                    ...
                    for syst in systematic_direction_signal:
                        ...
                        print "Applying cut:",cut
                        if syst == 'nominal':
                            temp2 = TH1F("temp2","temp2",100,100,2000)
                            ...
                            temp2sys = TH1F("temp2sys","temp2sys",100,100,2000)
