...
import sys
import numpy
systematic_direction_ttbar={'nominal':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                          'btag__plus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                          'btag__minus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                          'misbtag__plus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                          'misbtag__minus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                          'toptag__plus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_upT)',
                          'toptag__minus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_dnT)',
                          'mistoptag__plus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_upL)',
                          'mistoptag__minus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_dnL)',
                          'pileup__plus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu_up)*(wgtMC__ttagSF_ct)',
                          'pileup__minus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu_down)*(wgtMC__ttagSF_ct)',
                          'q2ttbar__plus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(wgtMC__muR_dn__muF_dn)*(weight_pu)*(wgtMC__ttagSF_ct)',
                          'q2ttbar__minus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(wgtMC__muR_up__muF_up)*(weight_pu)*(wgtMC__ttagSF_ct)',
                          'elecID__plus':'(wgtMC__elecIDSF_up)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                          'elecID__minus':'(wgtMC__elecIDSF_dn)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                          'elecHLT__plus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_up)*(weight_pu)*(wgtMC__ttagSF_ct)',
                          'elecHLT__minus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_dn)*(weight_pu)*(wgtMC__ttagSF_ct)'}
                         
systematic_direction_wjets={'nominal':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                            'btag__plus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                            'btag__minus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                            'misbtag__plus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                            'misbtag__minus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                            ...
                            'pileup__plus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu_up)*(wgtMC__ttagSF_ct)',
                            'pileup__minus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu_down)*(wgtMC__ttagSF_ct)',
                            'q2wjets__plus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(wgtMC__muR_dn__muF_dn)*(weight_pu)*(wgtMC__ttagSF_ct)',
                            'q2wjets__minus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(wgtMC__muR_up__muF_up)*(weight_pu)*(wgtMC__ttagSF_ct)',
                           'elecID__plus':'(wgtMC__elecIDSF_up)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                           'elecID__minus':'(wgtMC__elecIDSF_dn)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                           'elecHLT__plus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_up)*(weight_pu)*(wgtMC__ttagSF_ct)',
                           'elecHLT__minus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_dn)*(weight_pu)*(wgtMC__ttagSF_ct)'}

systematic_direction_otherbkgs = {'nominal':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                            'btag__plus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                            'btag__minus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                            'misbtag__plus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                            'misbtag__minus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
...
systematic_direction_signal= {'nominal':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                             'btag__plus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                             'btag__minus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                             'misbtag__plus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
                             'misbtag__minus':'(wgtMC__elecIDSF_ct)*(wgtMC__elecHLTSF_ct)*(weight_pu)*(wgtMC__ttagSF_ct)',
