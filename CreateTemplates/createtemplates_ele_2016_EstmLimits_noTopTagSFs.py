...
fout = TFile('el_theta_20161127.root', 'recreate')
    ...
    if cat == 'T1':
        ...
        for key_sample in samplelist:
            ...
            if key_sample == 'DATA':
                ...
                tempDATA = TH1F("tempDATA","tempDATA",60,0,6000)
                ...
                for syst in systematic_direction_signal:
                    ...
                    if syst == 'nominal':
                        ...
                        tempsys = TH1F("tempsys","tempsys",60,0,6000)
        ...
        for key_sample in samplelist:
            ...
            if key_sample == 'DATA':
                ...
                print "Processing: ",key_sample
                print "Applying cut:",cut
                temp2DATA = TH1F("temp2DATA","temp2DATA",60,0,6000)
        ...
        for key_sample in samplelist:
            ...
            if key_sample == 'DATA':
                ...
                print "Processing: ",key_sample
                print "Applying cut:",cut
                temp3DATA = TH1F("temp3DATA","temp3DATA",60,0,6000)
